...
case $TRAVIS_OS_NAME in
    linux)
        cp -rf $TRAVIS_BUILD_DIR/build/release/cinema_scope $TRAVIS_BUILD_DIR/installer/packages/cinemascope/data
    ...
    osx)
        ...
        ;;
    windows)
        cp -rf build/release/cinema_scope.exe installer/packages/cinemascope/data
